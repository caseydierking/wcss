...
function startGame() {
    ...
    barn = new component(600, 580, "images/barn.png", 510, 82, "image", 0, 0, 250, 188);
    hay = new component(100, 100, "images/hay.svg", 480, 180, "image", 0, 0, 200, 188);
    horse_shoe = new component(100, 100, "images/horseshoe.png", 510, 210, "image", 0, 0, 200, 188);

    // init apples

   var treeNum = Math.random() * 10 + 3;
   for (var j= 0; j< treeNum; j++) {
       var px = Math.random() * 800;
       var py = Math.random() * 550 + 180;
       var tree= new component(200, 250, "images/tree.png", px, py, "image", 0, 0, 200, 188);
       treeArr.push({
               px: px,
                py: py,
               tree: tree
    ...
    for (var j= 0; j< 5; j++) {
        var px = 587 + (j+1)*35;
        var py = 180;
        var fence= new component(150, 100, "images/fence.png", px, py, "image", 0, 0, 200, 188);
        fenceArr.push({
            px: px,
            py: py,
            fence: fence
